...
class CatalogServiceApplicationTests {
	...
	void whenGetRequestWithIdThenBookReturned() {
		...
		Book bookToCreate = Book.of(bookIsbn, "Title", "Author", 9.90, "Bookstore");
	...
	void whenPostRequestThenBookCreated() {
		Book expectedBook = Book.of("1231231231", "Title", "Author", 9.90, "Bookstore");
	...
	void whenPutRequestThenBookUpdated() {
		...
		Book bookToUpdate = new Book(createdBook.id(), createdBook.isbn(), createdBook.title(),
